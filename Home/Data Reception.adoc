...
The protocol used for data transmission is documented in the "Protocol Specification" document, located link:Home/Data%20Transmission/Protocol%20Specification[]. This document provides detailed information about the data format and transmission method.
